...
const users = [
  {
    ...
    infoLink: 'https://ottaaproject.com',
    pinned: true,
  },
];
...
const siteConfig = {
  ...
  tagline: '',
  url: 'https://ottaaproject.github.io', // Your website URL
  ...
  projectName: 'OTTAA Project Wiki',
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} OTTAA Project`,
